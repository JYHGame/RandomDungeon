...
public class PlayerRendomStatSystem : MonoBehaviour
{
    [Header("스탯 생성 규칙")]
    [SerializeField] private int totalStatPoints = 100; // 스탯 총합
    [SerializeField] private List<string> statTypes = new List<string>() { "힘", "민첩", "지능", "체력" }; // 스탯 종류
